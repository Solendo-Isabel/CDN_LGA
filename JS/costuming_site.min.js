...
const showPlayer = () =>{
    ...
    if (IFRAME.style.display === 'none' || IFRAME.style.display === '') {
        IFRAME.setAttribute("src",'http://192.168.20.175:3000/')
...
const sendInput = (Pointer) => {
    ...
    let translaterInput = IFRAME_BODY.querySelector("#translateInput")
    translaterInput.value = Pointer.target.textContent

    let translaterButton = IFRAME_BODY.querySelector("#translateButton")
    translaterButton.click()
    alert("Carregando animação")
